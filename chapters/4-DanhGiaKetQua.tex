...
\begin{itemize}
    ...
    \item \textbf{Capacity của cluster}: 8 vCPUs, 32 GB RAM
\end{itemize}
...
Thực nghiệm sử dụng 2 metrics để đánh giá quy trình học máy được đề cập trong nghiên cứu \cite{???}:
