...
Nhiều nghiên cứu đã ứng dụng các kỹ thuật học máy vào bài toán phát hiện gian lận trong lĩnh vực tài chính... Tuy nhiên, nghiên cứu này chủ yếu tập trung vào khía cạnh mô hình và dữ liệu, chưa xem xét các vấn đề liên quan đến triển khai và bảo mật trong môi trường vận hành thực tế.

Bên cạnh đó, một số công trình nghiên cứu đã áp dụng các nguyên tắc MLOps trong lĩnh vực tài chính nhằm tự động hóa quá trình huấn luyện, triển khai và giám sát mô hình... Tuy nhiên, các nghiên cứu này chủ yếu tập trung vào khía cạnh vận hành và hiệu năng của hệ thống, trong khi các rủi ro bảo mật của mô hình học máy chưa được phân tích sâu.

Ngoài ra, một số nghiên cứu đã chỉ ra rằng các mô hình học máy phát hiện gian lận có thể bị suy giảm nghiêm trọng hiệu năng khi chịu các hình thức tấn công đầu độc dữ liệu, đặc biệt là tấn công lật nhãn. Điều này cho thấy việc chỉ tập trung vào độ chính xác của mô hình là chưa đủ, mà cần có các cơ chế bảo vệ trong suốt vòng đời của hệ thống học máy.
...
Mục tiêu tổng quát của khóa luận là xây dựng một hệ thống phát hiện gian lận trong lĩnh vực tài chính, cụ thể là gian lận trong quá trình mở tài khoản ngân hàng, dựa trên các kỹ thuật học máy và được triển khai theo mô hình MLSecOps.
\begin{itemize}
  \item Nghiên cứu và lựa chọn các mô hình học máy phù hợp cho bài toán phát hiện gian lận với dữ liệu mất cân bằng trong lĩnh vực tài chính.
  \item Nghiên cứu và tích hợp phương pháp phát hiện tấn công lật nhãn nhằm giảm thiểu tác động của các hình thức tấn công đầu độc dữ liệu trong giai đoạn huấn luyện mô hình.
  \item Xây dựng quy trình phát hiện gian lận theo hướng MLSecOps, bao phủ toàn bộ vòng đời mô hình học máy từ xử lý dữ liệu, huấn luyện, đánh giá đến triển khai và giám sát.
...
\begin{itemize}
  ...
  \item Quy trình MLSecOps nhằm quản lý toàn bộ vòng đời của mô hình học máy, từ thu thập và tiền xử lý dữ liệu, huấn luyện, đánh giá đến triển khai và vận hành.
...
\label{sec:CauTruc}
Khóa luận với đề tài "XÂY DỰNG HỆ THỐNG PHÁT HIỆN GIAN LẬN TRONG LĨNH VỰC TÀI CHÍNH DỰA TRÊN MLSECOPS" được trình bày bao gồm 6 chương. Nội dung tóm tắt từng chương được trình bày như sau:
\begin{itemize}
